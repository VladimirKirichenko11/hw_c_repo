...
void run_tests() {
    ...
    printf("Test: Add to beginning... ");
    {
        struct Node* head = NULL;
        addToSortedList(&head, 30);
        addToSortedList(&head, 10);
        addToSortedList(&head, 20);
        assert(head->data == 10);
    ...
    printf("Test: Delete from empty list... ");
    {
        struct Node* head = NULL;
    ...
    printf("Test: Delete non-existent element... ");
    {
        struct Node* head = NULL;
        addToSortedList(&head, 10);
        addToSortedList(&head, 20);
    ...
    {
        struct Node* head = NULL;
        addToSortedList(&head, 50);
        addToSortedList(&head, 10);
        addToSortedList(&head, 30);
        addToSortedList(&head, 20);
        addToSortedList(&head, 40);
    ...
    printf("Test: Large list... ");
    {
        struct Node* head = NULL;
        for (int i = 0; i < 100; i++) {
            addToSortedList(&head, i);
        }
    ...
    printf("Test: Memory cleanup... ");
    {
        struct Node* head = NULL;
        for (int i = 0; i < 50; i++) {
            addToSortedList(&head, i * 2);
        }
        freeList(&head);
        assert(head == NULL);

        // Попытка использования после освобождения
        addToSortedList(&head, 100);
        assert(head != NULL);
    ...
    {
        struct Node* head = NULL;
        addToSortedList(&head, 1000000);
        addToSortedList(&head, -1000000);
        addToSortedList(&head, 0);

        assert(head->data == -1000000);
        assert(head->next->data == 0);
        assert(head->next->next->data == 1000000);
